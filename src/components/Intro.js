...
export default function Intro({setIsEntered}) {
    ...
    return (
        <div className={`w-full h-screen absolute top-0 left-0 z-40
            ...
            <div className={`w-max h-20 absolute top-1/2 -translate-y-1/2 left-1/2 transform -translate-x-1/2 flex flex-col justify-center items-center
                transition-all ease-in duration-1000 ${isFading ? 'opacity-0' : 'opacity-100'}`}>
